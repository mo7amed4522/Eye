// ignore_for_file: prefer_typing_uninitialized_variables, avoid_web_libraries_in_flutter, non_constant_identifier_names, avoid_print, await_only_futures, library_prefixes, invalid_use_of_visible_for_testing_member, deprecated_member_use, unused_local_variable
...
class AddNewProgrmmingControllerAR extends GetxController {
  num tourPrice = 1;
  num dura = 0;
  ...
  void changeTourPrice(num number) async {
    number = tourPrice;
    update();
  }

  void changeDura(num x) async {
    x = dura;
    update();
  }
